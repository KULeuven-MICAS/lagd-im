...
package data_read_pkg;
    ...
    `define MODEL_FILE "../../../sw/tests/data/model_1"
    `define FLIP_ICON_FILE_1 "../../../sw/tests/data/clusters_1"
    `define ENERGY_REF_FILE_1 "../../../sw/tests/data/energy_1"
    `define STATE_IN_FILE_1 "../../../sw/tests/data/states_in_1"
    `define STATE_OUT_FILE_1 "../../../sw/tests/data/states_out_1"
    `define FLIP_ICON_FILE_2 "../../../sw/tests/data/clusters_2"
    `define ENERGY_REF_FILE_2 "../../../sw/tests/data/energy_2"
    `define STATE_IN_FILE_2 "../../../sw/tests/data/states_in_2"
    `define STATE_OUT_FILE_2 "../../../sw/tests/data/states_out_2"
