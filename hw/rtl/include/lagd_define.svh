...
`define LAGD_DEFINE_SVH
    ...
    `define IC_REGS_BASE_ADDR 'h3000_0000 // Non-cacheable address space for Cheshire is [h3000_0000, h7fff_ffff]
    // L1 memory per core
    ...
    `define SC_COUNTER_BITWIDTH 17
    `define ITER_COUNTER_BITWIDTH 7
