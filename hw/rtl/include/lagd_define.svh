...
`define LAGD_DEFINE_SVH
    ...
    `define IC_J_MEM_END_ADDR 'h9010_0000    // real end address is 9000_8000 as J Mem Addr Space    32KB
    `define IC_FLIP_MEM_END_ADDR 'h9014_0000 // real end address is 9001_0000 as Flip Mem Addr Space 32KB
