...
$(RUN_TARGET): $(BUILD_TARGET) $(TEST_FILES) $(VSIM_SCRIPT) $(HDL_FILES) $(INCLUDE_FILES)
	...
	DEFINES="$(DEFINES)" HDL_FILE_LIST=$(HDL_FILES_LIST) PARAMS="$(PARAMS)" \
	OBJ=$(VSIM_OBJ_PREFIX)$(SIM_NAME) DBG=$(DBG) FORCE_BUILD=0  VSIM_FLAGS="$(VSIM_FLAGS)" \
	vsim $(RUN_FLAGS) -do "source $(VSIM_SCRIPT)" \
