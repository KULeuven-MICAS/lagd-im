...
# Declare clocks
#-----------------------------
source ${SDC_CONSTRAINTS_PATH}/sdc/core_clk.sdc
source ${SDC_CONSTRAINTS_PATH}/sdc/jtag_clk.sdc
# source ${SDC_CONSTRAINTS_PATH}/sdc/spi_clk.sdc
source ${SDC_CONSTRAINTS_PATH}/sdc/virt_clk.sdc
