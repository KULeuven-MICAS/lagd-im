...
#
# Converts sw/tests/data/default/clusters_1 and clusters_2 into a C header for bare-metal use.
#
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        "clusters_1 and clusters_2."
    )
    parser.add_argument(
        "--core-onload",
        type=int,
        default=0,
        help="Core index for the flip data section (default: 0).",
    )
    parser.add_argument(
        "--folder",
        type=str,
...
with open(OUTPUT_FILE, 'w') as f:
    ...
    f.write(f"// Sources: sw/tests/data/{args.folder}/clusters_1, sw/tests/data/{args.folder}/clusters_2\n")
