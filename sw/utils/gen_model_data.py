...
#
# Converts sw/tests/ref/data/default/model_<n+1> (the model of core n) into a C header for
# bare-metal use.
#
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Index of the core this data is loaded onto, selecting model_<n+1> "
             "and the J data section (default: 0).",
    )
    parser.add_argument(
        "--folder",
        type=str,
        default="default",
        help="Folder name under sw/tests/ref/data/ containing the model files (default: default).",
    )
    parser.add_argument(
        "--suffix",
        type=str,
...
args = parse_args()
print(f"suffix: {args.suffix}, core: {args.core_onload}")
...
INPUT_FILE = os.path.join(SW_DIR, "tests/ref/data", args.folder, INPUT_NAME)
...
with open(OUTPUT_FILE, 'w') as f:
    ...
    f.write(f"// Source: sw/tests/ref/data/{args.folder}/{INPUT_NAME}\n")
