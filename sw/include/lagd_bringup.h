...
static const lagd_core_config_t LAGD_BASE_CONFIG = {
    ...
    .en_comparison = 1,
    .en_perf_counter = 1,
    .enable_flip_detection = 1,
    .config_counter = 0xFF,
    .synchronizer_wbl_pipe_num = 3,
    .wwl_vdd_h = 1,
    .wwl_vread_h = 0,

    .cmpt_en = 0,
    .dt_cfg_enable = 0,
    .synchronizer_pipe_num = 3,
    .dgt_addr_upper_bound = 0x3F,
    .dgt_hscaling = 4,
    .energy_fifo_sel = 0,

    .cfg_trans_num = 0x0040,
    ...
    .wwl_vdd_cfg = {0xFFFFFFFFU, 0xFFFFFFFFU, 0xFFFFFFFFU, 0xFFFFFFFFU, 0xFFFFFFFFU, 0xFFFFFFFFU,
                    0xFFFFFFFFU, 0xFFFFFFFFU},
    .wwl_vread_cfg = {0x00000000U, 0x00000000U, 0x00000000U, 0x00000000U, 0x00000000U, 0x00000000U,
...
static void lagd_core_apply_config(unsigned core, const lagd_core_config_t *cfg) {
    ...
    *lagd_core_reg(core, LAGD_CORE_COUNTER_CFG_2_REG_OFFSET) =
        ...
        ((uint32_t)cfg->cycle_per_spin_write
         << LAGD_CORE_COUNTER_CFG_2_CYCLE_PER_SPIN_WRITE_OFFSET);
    ...
    *lagd_core_reg(core, LAGD_CORE_GLOBAL_CFG_2_REG_OFFSET) =
        ...
        ((uint32_t)cfg->synchronizer_pipe_num
         << LAGD_CORE_GLOBAL_CFG_2_SYNCHRONIZER_PIPE_NUM_OFFSET) |
        ((uint32_t)cfg->dgt_addr_upper_bound
    ...
    lagd_core_clear_bit(core, LAGD_CORE_GLOBAL_CFG_2_REG_OFFSET,
                        LAGD_CORE_GLOBAL_CFG_2_CONFIG_VALID_EM_BIT);
    lagd_core_clear_bit(core, LAGD_CORE_GLOBAL_CFG_2_REG_OFFSET,
                        LAGD_CORE_GLOBAL_CFG_2_CONFIG_VALID_FM_BIT);
